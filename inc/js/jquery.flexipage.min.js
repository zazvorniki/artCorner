...
(function ($) {
	$.fn.flexipage = function (options) {
		...
		return this.each(function () {
			...
			if (opts.pager == true) { (opts.showcounter == true) ? opts.showcounter = '<li><span class="actual"></span>/<span class="total">' + opts.total_pages + "</span></li>": opts.showcounter = " ";
				var pagerHTML = '<li class="prev"><a href="#">' + opts.prev_txt + "</a></li>" + opts.showcounter + '<li class="next"><a href="#">' + opts.next_txt + "</a></li>";
			...
			if (opts.navigation == true) {
				var navigationHTML = "";
				var actual;
				for (var i = 1; i <= opts.total_pages; i++) { (opts.firstpage == i) ? actual = ' class="active" ': actual = "";
	...
	$.fn.selectPage = function (n) {
		...
		if (n == "next") { (opts.actual < opts.total_pages) ? n = opts.actual + 1 : n = opts.total_pages
		}
		if (n == "prev") {
			if (opts.actual > 0) {
				n = opts.actual - 1
